...
@export var duracion_mensaje := 10.0
@export var escena_creditos := "res://Pantallas/CreditsScene.tscn"
...
func start_sequence():
	...
	while tiempo < duracion_mensaje and not cancelado:
		...
		if tiempo > duracion_mensaje - 2.0:
			...
			var p = (tiempo - (duracion_mensaje - 2.0)) / 2.0
